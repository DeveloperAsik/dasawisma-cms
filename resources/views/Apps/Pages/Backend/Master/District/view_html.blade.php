            ...
            <div class="portlet-title">
                ...
                <div class="actions">
                    <div class="btn-group">
                        ...
                        <a style="font-size:10px; text-align:center; display:none" title="Remove" class="btn dark btn-outline sbold col-ms-2" data-value="remove" data-id="remove" id="opt_remove">
